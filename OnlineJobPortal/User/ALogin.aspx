<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="ALogin.aspx.cs" Inherits="OnlineJobPortal.User.ALogin" %>
                                ...
                                <div class="col-sm-6">
                                 ...
                                 <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlLoginT" runat="server" CssClass="form-control w-100">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="UserType is required"
                                            ...
                                            ControlToValidate="ddlLoginT"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                               
                                <asp:Button ID="AdLo" runat="server" Text="Login" CssClass ="button button-contactForm boxed-btn mr-4"
                                      OnClick="AdLo_Click" />
