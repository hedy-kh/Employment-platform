        ...
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control"  placeholder=" Ex. Licence degree"  required >
                    </asp:TextBox>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control"  placeholder=" Ex . 2000$ Per Month"  required >
                    </asp:TextBox>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    <label for="fuCompanyLogo" style="font-weight: 600" style="display : none" > Company Logo   </label>
             ...
             <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-12 pt-3">
                    ...
                    <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control"  placeholder=" Enter Job Address"  
                        TextMode="MultiLine" required >
                    </asp:TextBox>
